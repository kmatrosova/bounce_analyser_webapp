...
interface BounceReasonsProps {
  stats: StatsData;
  breakdown: BreakdownData;
}

export default function BounceReasons({ stats, breakdown }: BounceReasonsProps) {
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
      ...
      <BreakdownPanel
        ...
        breakdown={breakdown}
        title="Breakdown"
        noDataMessage="No breakdown data available for this reason"
        clickMessage="Click on a bar or pie slice to see the breakdown"
      />
    </div>
  );
} 